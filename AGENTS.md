...
screen composes from it. Its section 11 carries the owner's rulings from the rebuild. A control the
mocks have no home for goes to a Linear issue for a ruling, never to a working
file in this repository, rather than being dropped or invented. Verify the change in a browser against a running coordinator; the
