...
func decodeWithSiteControlFragment(t *testing.T, fragment string) (NightSessionPayload, *ValidationError) {
	...
	return DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, alwaysTrueInterlockSignalResolver, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
}
...
func TestSiteControlActionCrossShowRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, christmasResolver, alwaysTrueInterlockSignalResolver, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
...
func TestSiteControlActionUnknownRejected(t *testing.T) {
	raw := withTopLevelFragment(validNightSessionJSON, `"siteControl":{"presentationPowerOn":{"action":"site-on","powerDomain":"presentation","domainProvenance":"operator-declared"}}`)
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysFalseActionResolver, alwaysTrueInterlockSignalResolver, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
...
func TestInterlockSignalNonMQTTRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, nonMQTT, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
...
func TestInterlockSignalExpectNoneRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, fireAndForget, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
	if verr == nil || verr.Code != ValidationCodeInterlockSignalNotConfirmable {
...
func TestInterlockSignalCrossShowRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, christmas, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
	if verr == nil || verr.Code != ValidationCodeCrossShowReference {
...
func TestInterlockSignalUnresolvableRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, none, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
	if verr == nil || verr.Code != ValidationCodeFieldUnknownReference {
...
func TestInterlockBlockSignalTextKindRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, textKind, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
...
func TestInterlockBlockSignalNumberWithNoValueRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, numberNoValue, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
	if verr == nil || verr.Code != ValidationCodeInterlockSignalNoFalseAnswer {
...
func TestInterlockBlockSignalNumberWithValueAccepted(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, numberWithValue, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists)
	if verr != nil {
