...
func TestSiteControlActionCrossShowRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, christmasResolver, alwaysTrueInterlockSignalResolver, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
...
func TestSiteControlActionUnknownRejected(t *testing.T) {
	raw := withTopLevelFragment(validNightSessionJSON, `"siteControl":{"presentationPowerOn":{"action":"site-on","powerDomain":"presentation","domainProvenance":"operator-declared"}}`)
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysFalseActionResolver, alwaysTrueInterlockSignalResolver, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
...
func TestInterlockSignalNonMQTTRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, nonMQTT, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
...
func TestInterlockSignalExpectNoneRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, fireAndForget, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
	if verr == nil || verr.Code != ValidationCodeInterlockSignalNotConfirmable {
...
func TestInterlockSignalCrossShowRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, christmas, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
	if verr == nil || verr.Code != ValidationCodeCrossShowReference {
...
func TestInterlockSignalUnresolvableRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, none, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
	if verr == nil || verr.Code != ValidationCodeFieldUnknownReference {
...
func TestInterlockBlockSignalTextKindRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, textKind, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
...
func TestInterlockBlockSignalNumberWithNoValueRejected(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, numberNoValue, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
	if verr == nil || verr.Code != ValidationCodeInterlockSignalNoFalseAnswer {
...
func TestInterlockBlockSignalNumberWithValueAccepted(t *testing.T) {
	...
	_, verr := DecodeNightSessionPayload(raw, nightSessionTestEndpoints, alwaysTrueAssetCurrent, alwaysTrueActionResolver, numberWithValue, alwaysTrueMediaPlaylistCurrent, alwaysTrueAudioNodeExists, nil)
	if verr != nil {
