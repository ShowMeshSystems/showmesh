...
func TestMigrateV19KeepsStoredRevisionsAtTheSameLevel(t *testing.T) {
	...
	seedAudioSettingsRevision(t, db, 1,
		`{"driftIgnoreThresholdMs":20,"defaultFadeCurve":"linear","defaultFadeDurationMs":1000,`+
			`"defaultMaxBackgroundGain":0.6,"duckTargetGain":0.25,"ltcFrameRate":"30","ltcDefaultStartOffset":"00:00:00:00","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`)
	seedAudioSettingsRevision(t, db, 2,
		`{"driftIgnoreThresholdMs":20,"defaultFadeCurve":"linear","defaultFadeDurationMs":1000,`+
			`"defaultMaxBackgroundGain":1,"duckTargetGain":0,"ltcFrameRate":"30","ltcDefaultStartOffset":"00:00:00:00","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`)
...
func TestMigrateV19ClampsTheOldCeilingBoundIntoRange(t *testing.T) {
	...
	seedAudioSettingsRevision(t, db, 1,
		`{"driftIgnoreThresholdMs":20,"defaultFadeCurve":"linear","defaultFadeDurationMs":1000,`+
			`"defaultMaxBackgroundGain":4,"duckTargetGain":0.25,"ltcFrameRate":"30","ltcDefaultStartOffset":"00:00:00:00","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`)
...
func TestMigrateV19LeavesAlreadyMigratedRevisionsAlone(t *testing.T) {
	const already = `{"driftIgnoreThresholdMs":20,"defaultFadeCurve":"linear","defaultFadeDurationMs":1000,` +
		...
		`"duckRestoreFadeDurationMs":800,"ltcFrameRate":"30","ltcDefaultStartOffset":"00:00:00:00","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`
