...
func TestMigrateV20BackfillsMissingRequiredFields(t *testing.T) {
	...
	seedAudioSettingsRevision(t, db, 2,
		`{"driftIgnoreThresholdMs":20,"defaultFadeCurve":"linear","defaultFadeDurationMs":1000,`+
			`"defaultMaxBackgroundGainDb":-4.44,"ltcFrameRate":"30","ltcDefaultStartOffset":"00:00:00:00","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`)
...
func TestMigrateV20LeavesCompletePayloadsAlone(t *testing.T) {
	...
	const complete = `{"driftIgnoreThresholdMs":500,"defaultFadeCurve":"linear","defaultFadeDurationMs":2500,` +
		...
		`"duckRestoreFadeDurationMs":900,"ltcFrameRate":"25","ltcDefaultStartOffset":"01:02:03:04","scheduledStartDeliveryBoundMs":2000,"scheduledStartMarginMs":1000,"multisyncFallbackWindowMs":1500,"multisyncStartLeadMs":100}`
