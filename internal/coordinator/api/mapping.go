...
func mapNode(nv inventory.NodeView, now time.Time, decl *store.NodeDeclarationRecord, latestRun *store.DiscoveryRunRecord, renderObs, audioObs, clockObs, fppConnectObs []observation.Observation) v1.Node {
