...
// runLoop executes the gate's current latestRun under the gate's current
// generation, then either stops (no follow-up was requested while it
// ran) or immediately executes again for whatever generation and run
