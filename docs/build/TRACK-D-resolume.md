...
Status: D-1 built and verified against the running Arena 2026-08-14; D-2 built 2026-08-14 and closed 2026-08-15; **D-3 built, reviewed and closed 2026-08-15, and driven against a real Arena the same day** ([results](../bench/TRACK-D-LIVE-VERIFICATION.md) §6, on the development laptop and not the playout machine); [D-3a, crash recovery](TRACK-D-D3A-CRASH-RECOVERY-SPEC.md) is specified and not built, **with no owner decisions outstanding**: its §7 was answered 2026-08-15 and a pre-build review's six further questions were answered 2026-08-16 as its §10. **The build order is [ADR-037](../decisions/ADR-037-resolume-references-are-names-not-ids.md) seam B, then D-3a, then D-4** (owner, 2026-08-16); D0 (the timecode bench) is outstanding and not gating, but **it now carries a case D-3a depends on**, see the deliverables section. Specified 2026-08-13. **Day-0 scope**, promoted from "not sequenced" the same day.
