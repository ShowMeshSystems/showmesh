...
>
> **Nothing in D-2 or D-3 has run against real hardware.** D-1 was exercised against the operator's running Arena; everything since is unit-test evidence. [The live-verification checklist](../bench/TRACK-D-LIVE-VERIFICATION.md) is what would change that.
