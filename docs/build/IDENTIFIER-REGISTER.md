...
| v26 | shipped | Lane 17a SM-111: `commands.requested_revision` renamed to `commands.caller_intent`, with its per-family discriminator formalized (owner, 2026-08-19). Renumbered from v22, which was renumbered from v13. Shipped 2026-08-31 as `migrateV26RenameRequestedRevisionToCallerIntent` |
