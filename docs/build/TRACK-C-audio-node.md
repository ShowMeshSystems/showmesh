...
Status: **C0a-1 and C0a-2 complete, 2026-08-18.** Specified 2026-08-13; dependency-complete review 2026-08-17. Pipeline/graph behaviour measured in C0a-1 is L2 (see RES-007); everything hardware- or device-dependent, and every engine seam past C0a (C1 onward), remains L0 design intent until the benches or seams below run for real.
