...
- **[Track F, resting mode and night-session control](TRACK-F-resting-mode.md).** The FPP-authorized rest/show loop, exact-FSEQ-derived timing, independently offset transition cues, final-show handling, and safe presentation power sequencing. Added 2026-08-16 from the owner's operating-day workflow and governed by [ADR-038](../decisions/ADR-038-fpp-authorizes-night-sessions.md) and [RESTING-MODE](../architecture/RESTING-MODE.md). It integrates Tracks C, D, and E after their underlying audio, action, and asset seams exist; it does not add calendar scheduling to ShowMesh.
