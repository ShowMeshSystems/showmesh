...
| [ADR-028](ADR-028-show-asset-store-and-identity.md) | Show asset store; a filename is not an asset identity | Accepted (decision 10 amended in 2026-08-17: re-uploading superseded bytes is a rollback) |
