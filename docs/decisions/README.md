...
| [ADR-043](ADR-043-show-scoped-cues-and-playlist-authority.md) | Show-scoped Cues and pluggable Playlist authority | Accepted (owner, 2026-08-20; **narrows** ADR-001 to FPP-backed Playlists, makes runner authority explicit, and requires active-show isolation across Cue activation and execution. ADR-042 is assigned on the in-flight Track C branch.) |
