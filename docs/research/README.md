...
| [RES-020](RES-020-multisync-triggered-cue-start.md) | MultiSync-triggered Cue start and PCM delivery | in progress (current-path lateness L2 2026-09-17; FPP start lifecycle L1 2026-09-18; new-path rig runs L2 2026-09-18, audible-sample measurement L0) | critical | RES-002, RES-019 |
