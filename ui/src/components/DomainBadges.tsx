...
// Only rendered once `ready` is false: every failing condition (H2 spec
// §6's original five, plus Lane 16's `node-render-unassigned`,
// `exclusive-claim-conflict`, and `node-catalog-stale` additions) is its
