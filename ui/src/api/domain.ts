...
export type AssetSyncVerdict = components['schemas']['AssetSyncVerdict']
export type AssetVerdictSource = components['schemas']['AssetVerdictSource']
export type AssetLastFetch = components['schemas']['AssetLastFetch']
export type ResyncRequestStatus = components['schemas']['ResyncRequestStatus']
...
export type NightBackgroundAudioStep = components['schemas']['NightBackgroundAudioStep']
export type NightBackgroundAudio = components['schemas']['NightBackgroundAudio']
export type NightAuthorization = components['schemas']['NightAuthorization']
export type NightCycleOutcome = components['schemas']['NightCycleOutcome']
